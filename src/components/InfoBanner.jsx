...
export const InfoBanner = () => {
  return (
    <div className="max-w-7xl mx-auto   my-16 px-4 lg:px-12 ">
      <div className="flex  flex-col items-center bg-gradient-to-b from-blue-500 to-[#03b2e2]  py-[120px] [box-shadow:0px_1px_8px_rgba(13,34,71,0.12),0px_28px_108px_rgba(13,34,71,0.1),inset_0px_-1px_1px_rgba(13,34,71,0.12)] rounded-2xl ">
